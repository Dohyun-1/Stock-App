...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Bottom navigation */}
      <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-white/20 bg-slate-900/95 backdrop-blur">
        <div className="mx-auto flex max-w-lg items-stretch justify-around">
          {bottomNavItems.map((item) => {
            ...
            return (
              ...
              >
                <span className={active ? "text-cyan-400" : "text-white"}>
                  {item.icon}
                </span>
                {item.label}
              </Link>
